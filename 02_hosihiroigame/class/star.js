class Star extends Material {
    ...
    constructor(x, y, dw, dh, imagesrc) {
        ...
        this.rotateDegrees = this.getRandomInt(1, 3) * (getRandomInt(0, 1) === 1) ? 1 : -1;
        this.imagerotate();
    ...
    imagerotate() {
        // 移動方向を設定するメソッド
        this.imageangle += this.rotateDegrees;
        setTimeout(() => this.imagerotate(), 10); // 無名関数を使用
    ...
    kingyo_randome_angle() {
        ...
        this.speed = this.getRandomInt(1, 2);
    }
